...
def register_minigrid_envs():
    ...
    register(
        ...
        entry_point='minigrid.envs.MyEnvs:Dense_Easy'
    )

    register(
        id='MiniGrid-Sparse_Easy-v0',
        entry_point='minigrid.envs.MyEnvs:Sparse_Easy'
    )

    register(
        id='MiniGrid-Dense_Easy_2-v0',
        entry_point='minigrid.envs.MyEnvs:Dense_Easy_2'
    )

    register(
        id='MiniGrid-Sparse_Easy_2-v0',
        entry_point='minigrid.envs.MyEnvs:Sparse_Easy_2'
    )

    register(
        id='MiniGrid-Dense_Medium-v0',
        entry_point='minigrid.envs.MyEnvs:Dense_Medium'
    )

    register(
        id='MiniGrid-Sparse_Medium-v0',
        entry_point='minigrid.envs.MyEnvs:Sparse_Medium'
    )

    register(
        id='MiniGrid-Dense_Medium_2-v0',
        entry_point='minigrid.envs.MyEnvs:Dense_Medium_2'
    )

    register(
        id='MiniGrid-Sparse_Medium_2-v0',
        entry_point='minigrid.envs.MyEnvs:Sparse_Medium_2'
    )

    register(
        id='MiniGrid-Dense_Hard-v0',
        entry_point='minigrid.envs.MyEnvs:Dense_Hard'
    )

    register(
        id='MiniGrid-Sparse_Hard-v0',
        entry_point='minigrid.envs.MyEnvs:Sparse_Hard'
    )

    register(
        id='MiniGrid-Dense_Hard_2-v0',
        entry_point='minigrid.envs.MyEnvs:Dense_Hard_2'
    )

    register(
        id='MiniGrid-Sparse_Hard_2-v0',
        entry_point='minigrid.envs.MyEnvs:Sparse_Hard_2'
    )
