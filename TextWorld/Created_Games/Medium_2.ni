...
The Kitchen part 0 is some text that varies. The Kitchen part 0 is "You find yourself in a Kitchen. An ordinary kind of place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
 ...
 You can make out a fridge.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0]. Hmmm... what else, what else?[end if]".
...
The Kitchen part 3 is some text that varies. The Kitchen part 3 is " door leading west.".
...
The LivingRoom part 0 is some text that varies. The LivingRoom part 0 is "Well, here we are in a LivingRoom.
 ...
 You can see a table. [if there is something on the s_0]On the table you see [a list of things on the s_0].[end if]".
...
The s_0 is in r_0.
The description of f_0 is "The apple looks delectable.".
