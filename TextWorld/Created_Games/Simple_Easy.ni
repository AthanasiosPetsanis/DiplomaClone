...
The Bedroom part 0 is some text that varies. The Bedroom part 0 is "You arrive in a Bedroom. An ordinary kind of place.
 ...
 You make out a table. You shudder, but continue examining the table. [if there is something on the s_0]You see [a list of things on the s_0] on the table.[end if]".
The Bedroom part 1 is some text that varies. The Bedroom part 1 is "[if there is nothing on the s_0]However, the table, like an empty table, has nothing on it.[end if]".
...
The s_0 is in r_0.
The description of o_0 is "The glasses is unremarkable.".
The printed name of o_0 is "glasses".
Understand "glasses" as o_0.
