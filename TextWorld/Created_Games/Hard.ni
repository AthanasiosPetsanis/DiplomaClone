...
The LivingRoom part 0 is some text that varies. The LivingRoom part 0 is "Welcome to the LivingRoom. You begin looking for stuff.

 You can see a table. [if there is something on the s_0]You see [a list of things on the s_0] on the table.[end if]".
The LivingRoom part 1 is some text that varies. The LivingRoom part 1 is "[if there is nothing on the s_0]But the thing hasn't got anything on it.[end if]".
